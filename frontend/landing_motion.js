...
const PLANS = [
  ...
  {
    id: 'yearly',
    badge: 'خصم 50% (وفر $300 👑)', badgeColor: '#f59e0b',
    name: 'سنوي', price: '$300', original: '$600', period: '/ سنة', saving: 'وفّر 50% ($300)',
    features: ['خصم 50% كامل بنصف السعر ($25/شهر)', 'توفير قيمة 6 شهور مجاناً 🎁', 'نشر وإدارة قنوات غير محدودة', 'بروكسي SOCKS5 مخصص مجاني مدمج'],
