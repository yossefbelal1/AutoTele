...
const PLANS = [
  ...
  {
    id: 'monthly',
    badge: '⭐ الأكثر طلباً', badgeColor: '#00c8ff',
    name: 'شهري', price: '$50', original: null, period: '/ شهر', saving: null,
  ...
  {
    id: 'half_year',
    badge: 'وفر $60 (خصم 20%)', badgeColor: '#f59e0b',
    name: '6 شهور', price: '$240', original: '$300', period: '/ 6 شهور', saving: 'وفّر $60 ($40/شهر)',
    features: ['توفير $60 بمعدل ($40/شهر فقط)', 'خوادم خاصة فائقة السرعة للعميل', 'دعم كامل لوكيل (Proxy SOCKS5) خاص', 'دعم فني مخصص ومباشر 24/7'],
    isPrimary: false, btnText: 'تفعيل باقة 6 شهور',
  },
  {
    id: 'yearly',
    badge: 'وفر $200 (4 شهور مجاناً 👑)', badgeColor: '#f59e0b',
    name: 'سنوي', price: '$400', original: '$600', period: '/ سنة', saving: 'وفّر 4 شهور ($200)',
    features: ['توفير قيمة 4 شهور مجاناً 🎁 ($33/شهر)', 'نشر وإدارة قنوات غير محدودة', 'بروكسي SOCKS5 مخصص مجاني مدمج', 'مستشار ومدير حساب مخصص بالكامل'],
